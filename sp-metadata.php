...
/**
 * Copyright (C) 2019-2024 Combodo SAS
 *
...
$aAttributes = isset($aSettings['sp']['attributeConsumingService']) ? $aSettings['sp']['attributeConsumingService'] : [];
$aContactPerson = isset($aSettings['contactPerson']) ? $aSettings['contactPerson'] : [];
$aOrganization = isset($aSettings['organization']) ? $aSettings['organization'] : [];
